...
class MockNapCatServer:
    def __init__(self, port: int, testname: str, test_json_path: str, version: str = "0.2"):
        self.port = port
...
def main():
    ...
    parser.add_argument('--version', default='0.2', help='测试资源版本')

    args = parser.parse_args()

    server = MockNapCatServer(args.port, args.testname, args.test_json, args.version)
